...
CLASS_NUM = 2
BATCH_SIZE = 16
EPOCH_STEPS = int(323 / BATCH_SIZE)
IMAGE_SHAPE = (224, 224, 3)
IMAGE_TRAIN = 'D:/Fathima/Python/medical image/database/train'
MODEL_NAME = 'googlenet_flower.h5'

print ("fgdshjkdhiuhydshdjshfdushfdjs")
...
model.save(r"D:/Fathima/Python/medical image/model-1.h5")

plt.style.use("ggplot")
plt.figure()
plt.plot(train_history.history['aux2_accuracy'],'r',label='validation accuracy',color='green')
plt.xlabel('# epochs')
plt.ylabel('loss')
plt.legend()
plt.savefig(r"D:\Fathima\Python\medical image\model-1.png")
plt.show()

vgg_acc=train_history.history['val_accuracy'][-1]
print(vgg_acc)
...
#
#
# show_train_history(history_all, 'Epoch', 'Accuracy', ('main_accuracy', 'aux1_accuracy', 'aux2_acc'))
